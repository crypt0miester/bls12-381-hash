...
// Literals are in the tables' 2^384 domain; ms/msa/msa2 lift them to the
// crate's 2^390 Montgomery domain at compile time (see consts_g1.rs).

use crate::consts_g1::{ms, msa, msa2};

pub const SSWU2_ELLP_A: [[u64; 6]; 2] = msa([
...
pub const SSWU2_C1_NEG_B_OVER_A: [[u64; 6]; 2] = msa([
...
pub const ISO3_XNUM: [[[u64; 6]; 2]; 4] = msa2([
    [
...
pub const ISO3_XDEN: [[[u64; 6]; 2]; 3] = msa2([
    [
        [0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000],
...
pub const ISO3_YNUM: [[[u64; 6]; 2]; 4] = msa2([
    [
...
pub const ISO3_YDEN: [[[u64; 6]; 2]; 4] = msa2([
    [
...
pub const ISO3A_XNUM: [[[u64; 6]; 2]; 4] = msa2([
    [
        [
            0x447600000027552e,
            0xdcb8009a43480020,
...
pub const ISO3A_YNUM: [[[u64; 6]; 2]; 4] = msa2([
    [
        [
            0x66b10000003affc5,
            0xcb1400e764ec0030,
...
pub const ISO3A_YDEN: [[[u64; 6]; 2]; 3] = msa2([
    [
        [
            0x66b10000003affc5,
            0xcb1400e764ec0030,
...
pub const ISO3A_XDEN: [[[u64; 6]; 2]; 2] = msa2([
    [
        [
            0x447600000027552e,
            0xdcb8009a43480020,
